...
<body>
序号:<input type="text" id="pid" name="pid" required disabled><br>
...
<script type="text/javascript" charset="utf-8">
    $(function () {
        ...
        $.ajax({
            ...
            dataType: "json",
            async:false,
            data: {type:"selectO",pid:$("#pid",window.opener.document).val()},
            success: function (data) {
                $.each(data.productList,function (i, v) {
                    let trs = ["pid","pname","marketprice","shopprice","ishot","csid","pdesc"];
        ...
        function edit(url,message){
            ...
            for (let i = 0; i < $body.length ; i++) {
                if (($body.eq(i).attr("id")!=="image")&&($body.eq(i).val()==null||$body.eq(i).val()=="")){
                    isN = false;
                    return;
                }
            }
